...
//          {!showForm && (
//         <div>
//           <button className="btn btn-primary btn-sm w-100" onClick={handleCreateClick}>
//             Create
//           </button>
//         </div>
//       )}
    ...
    return (
      ...
      <div >
        ...
        <div style={{display:'flex',justifyContent:'space-between'}}>
          <p style={{color:'black', fontWeight:'bold'}}>Create Portfolio</p>
          <div>
          <button className="btn  w-100 "  
          style={{
              border: '1px solid var(--primary-color)', // Add border
              color: '#678983', // Add text color
            }} 
          ...
          <Portfolio source="managePortfolio" />
      </div>
    );
  };
